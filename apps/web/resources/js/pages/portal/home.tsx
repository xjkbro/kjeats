...
import type { FeedItem, FeedItemDishRating, FeedItemRecipe, FeedItemRestaurant, Recipe, Restaurant } from '@/types/portal';
...
function DishRatingFeedItem({ item }: { item: FeedItemDishRating }) {
    return (
